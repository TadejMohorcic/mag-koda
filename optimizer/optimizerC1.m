function [bx1, by1, bx2, by2] = optimizerC1(x0, Bx1, By1, Bx2, By2, u, v, functional)
...
x_opt = fmincon(@(x) optimizer_functionalC1(x, Bx1, By1, Bx2, By2, u, v, functional), x0, [], [], [], [], [], [], @(x) opt_jacobiC1(x, Bx1, By1, Bx2, By2, u, v), opts);
...
interior_x2 = reshape(x_opt(interior_start:interior_start+interior_size2-1), [o-3, n-2]);
interior_y2 = reshape(x_opt(interior_start+interior_size2:interior_start+2*interior_size2-1), [o-3, n-2]);
